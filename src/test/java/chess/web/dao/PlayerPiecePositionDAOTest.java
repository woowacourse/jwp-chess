...
import static chess.web.domain.position.type.File.A;
import static chess.web.domain.position.type.File.C;
import static chess.web.domain.position.type.File.D;
import static chess.web.domain.position.type.File.H;
import static chess.web.domain.position.type.Rank.EIGHT;
import static chess.web.domain.position.type.Rank.FIVE;
import static chess.web.domain.position.type.Rank.ONE;
