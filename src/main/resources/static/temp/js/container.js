const room = function (roomId, title, locked, playerAmount) {
  return `    
    ...
    <div class="game">
      ...
      <div class="game-info">
        ...
        <div class="enemy info">
          ...
          <div class="piece">
            <i class="fas fa-chess-queen piece-black"></i>
          </div>
        </div>
        <div class="chess-time">
          <div class="arrow">
        ...
        <div class="me info">
          ...
          <div class="piece">
            <i class="fas fa-chess-queen piece-white"></i>
          </div>
        </div>
      </div>
      <!--채팅-->
