...
public class SpringChessGameRestController {
    ...
    public ResponseEntity<Boolean> checkCurrentTurn(@PathVariable String roomId, @PathVariable String clickedSection) {
    ...
    public ResponseEntity<List<String>> findMovablePosition(@PathVariable String roomId, @PathVariable String clickedSection) {
        ChessGame chessGame = roomService.loadChessGameById(roomId);
        return ResponseEntity.status(OK)
    ...
    public ResponseEntity<StatusDTO> movePiece(@PathVariable String roomId, @RequestBody @Valid final MoveDTO moveDTO) {
    ...
    public ResponseEntity<Boolean> endGame(@PathVariable String roomId, @RequestBody @Valid final ResultDTO resultDTO) {
