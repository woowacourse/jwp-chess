...
import static wooteco.chess.domain.piece.Pawn.*;
...
import wooteco.chess.exception.OtherPieceInPathException;
import wooteco.chess.exception.PawnNotAttackableException;
import wooteco.chess.exception.PieceNotFoundException;
import wooteco.chess.exception.SameTeamPieceException;
