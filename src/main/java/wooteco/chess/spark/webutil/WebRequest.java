...
//        ChessService chessService = ChessService.getInstance();
//
//        Position start = Position.of(req.getParameter("start"));
//        Position end = Position.of(req.getParameter("end"));
//        tryMove(start, end);
//
//        return ModelParser.parseBoard(chessService.readBoard());
//    }),
...
//            model.put("start", req.getParameter("start"));
//        }
//        return model;
//    });
//
...
//    }
//
//    public Map<String, Object> generateModel(final ServletRequest request) throws SQLException {
//        return this.generateModel.action(request);
//    }
//
//    private interface ThrowingFunction {
//        Map<String, Object> action(ServletRequest request) throws SQLException;
//    }
//}
