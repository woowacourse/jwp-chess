...
* [o] localhost:8080 에서 체스방을 만들 수 있어야 한다.
  * [o] chess_game에서 gameName을 primary_key로 사용하던 테이블을 고유 식별값인 id를 primary_key로 사용하도록 바꾼다.
  * [o] controller의 url 매핑구조도 id를 통해 접근하도록 수정한다.
  * [o] 체스방 제목과 비밀번호를 입력해 만든다.
    * [o] 체스방 테이블이 비밀번호를 갖도록 수정한다.
  * [o] 체스방에는 고유식별값이 부여된다. (체스방 주소에 사용된다.)
* [o] localhost:8080 에서 체스방 목록을 조회할 수 있어야 한다.
  * [o] 체스방 제목과 체스방 삭제버튼이 표시된다.
* [o] 체스방 목록에서 체스방 제목을 클릭하면 체스 게임을 이어서 진행할 수 있어야 한다.
