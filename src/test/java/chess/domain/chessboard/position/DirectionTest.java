package chess.domain.chessboard.position;
...
import static chess.domain.chessboard.position.Direction.EAST;
import static chess.domain.chessboard.position.Direction.NORTH;
