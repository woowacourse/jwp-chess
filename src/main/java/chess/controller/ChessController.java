...
public class ChessController {
    ...
    @PatchMapping("/{id}/end")
    public ResponseEntity<StatusResponseDto> finishGame(@PathVariable Long id, @RequestBody RoomAccessRequestDto roomAccessRequestDto) {
        chessService.endRoom(id, roomAccessRequestDto);
