...
public class ChessRepositoryTest {
    ...
    @Test
    void createTest() {
        ChessEntity savedEntity = chessRepository.save(ChessEntity.of("cherry", INIT_BOARD_INFORMATION, true));
        assertThat(savedEntity).isNotNull();
    }

    @Test
    void findAllIdsTest() {
        chessRepository.save(ChessEntity.of("cherry", INIT_BOARD_INFORMATION, true));
        chessRepository.save(ChessEntity.of("cherry", INIT_BOARD_INFORMATION, true));
        chessRepository.save(ChessEntity.of("cherry", INIT_BOARD_INFORMATION, true));
