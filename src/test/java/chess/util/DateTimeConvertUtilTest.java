...
class DateTimeConvertUtilTest {
    ...
    void Date_to_LocalDateTime() throws ParseException {
        ...
        Timestamp timestamp = DateTimeConvertUtil.toTimestampFrom(init);
        LocalDateTime converted = DateTimeConvertUtil.toLocalDateTimeFrom(timestamp);
