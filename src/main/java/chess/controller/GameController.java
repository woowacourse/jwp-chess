...
public class GameController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ChessGameResponse> getGame(@PathVariable Long id) {
    ...
    @GetMapping("/{id}/score")
    public ResponseEntity<ScoresResponse> getScore(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> movePiece(@PathVariable Long id, @RequestBody MoveRequest moveRequest) {
        chessGameService.movePiece(id, moveRequest.toEntity());
        return ResponseEntity.noContent().build();
    }

    @PutMapping("/{id}")
    public ResponseEntity<ScoresResponse> updateStatusToFinish(@PathVariable Long id) {
